...
const Heatmap = (() => {
    ...
    function render(container, data, color = '#6C5CE7') {
        ...
        dayLabels.style.cssText = 'display:flex;flex-direction:column;gap:3px;margin-right:4px;font-size:9px;color:var(--text-tertiary);';
        ['M', 'T', 'W', 'T', 'F', 'S', 'S'].forEach(l => {
            const s = document.createElement('span');
            s.textContent = l;
            s.style.cssText = 'width:14px;height:14px;display:flex;align-items:center;justify-content:center;';
